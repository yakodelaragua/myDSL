 ...
 */
package diazdecerio.mydsl;

import com.google.inject.Binder;
import com.google.inject.Provider;
import com.google.inject.name.Names;
import diazdecerio.mydsl.generator.MyDslGenerator;
import diazdecerio.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import diazdecerio.mydsl.parser.antlr.MyDslParser;
import diazdecerio.mydsl.parser.antlr.internal.InternalMyDslLexer;
import diazdecerio.mydsl.scoping.MyDslScopeProvider;
import diazdecerio.mydsl.serializer.MyDslSemanticSequencer;
import diazdecerio.mydsl.serializer.MyDslSyntacticSequencer;
import diazdecerio.mydsl.services.MyDslGrammarAccess;
import diazdecerio.mydsl.validation.MyDslConfigurableIssueCodesProvider;
import diazdecerio.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "diazdecerio/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("diazdecerio.mydsl.MyDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("diazdecerio");
	}
